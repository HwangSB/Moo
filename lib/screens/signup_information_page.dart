...
class _SignupInformationPageState extends State<SignupInformationPage> {
  ...
  FarmType _farmTypeGroupValue = FarmType.onGoing;
  FarmScale _farmScaleGroupValue = FarmScale.s1;
  FarmLocation _farmLocationGroupValue = FarmLocation.gangwon;
                                      ...
                                      children: <Widget>[
                                        Flexible(
                                          ...
                                          child: CircularButton(
                                            ...
                                            textStyle: tagTextStyle,
                                            onTap: () => setState(() {
                                              _farmLocationGroupValue =
                                                  FarmLocation.gangwon;
                                            }),
                                          ),
                                        ),
                                        SizedBox(width: 16.0),
