...
class MainContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: RestService.instance.getHome(),
      initialData: HomeResult('', 0, 0),
      builder: (context, snapshot) {
        HomeResult homeResult = snapshot.data;
        return Container(
          child: Column(
            children: <Widget>[
              Stack(
                                      ...
                                      Text.rich(
                                        TextSpan(
                                          children: <TextSpan>[
                                            ...
                                            TextSpan(
                                              text: '${homeResult.price - homeResult.lastPrice}',
                                              style: TextStyle(
                                                fontFamily: 'SCDream',
                                                fontWeight: FontWeight.w700,
                                                fontSize: MediaQuery.of(context)
